<?
	...
	$controllerTitles = ['faction' => 'Сменить фракцию',
						  'race' => 'Сменить расу',
						  'name' => 'Сменить имя',
						  'customize' => 'Сменить внешность'];?>
...
<? if (isset(\Engine\View::instance() -> charactersList) && is_array(\Engine\View::instance() -> charactersList)): ?>
	<? foreach (\Engine\View::instance() -> charactersList as $character): ?>
		<div class="list_block list_block_available" onclick="loadController('<?=\Helper\Url::getUrl('shop', 'character', ['type' => \Engine\View::instance() -> operationType, 'guid' => $character['guid']]);?>');">
	...
	<? endforeach; ?>
	Стоимость услуги - <?= \Engine\View::instance() -> costs[\Engine\View::instance() -> operationType]; ?>
<? else: ?>
